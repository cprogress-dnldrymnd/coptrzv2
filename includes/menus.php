					...
					if ($submenus2) {
						...
						foreach ($submenus2 as $submenu2) {
							...
							if ($status == 'publish' || $post_id == 0) {
								...
								$html .= '<li>';
								$html .= '<a id="anchor-submenu-' . $submenu2_id . '" class="nav-link text-black  nav-link-2 ' . ($submenus3 ? 'has-children-tab' : '') . '"  url_target="#submenu-' . $submenu2_id . '" href="' . $submenu2['url'] . '">';
								$html .= $submenu2['title'];
						...
						foreach ($submenus2 as $submenu2) {
							...
							if ($submenus3) {
								...
								foreach ($submenus3 as $submenu3) {
									...
									$html .= '<li>';
									$html .= '<a class="nav-link text-black  nav-link-3 ' . ($submenus4 ? 'has-children-tab' : '') . '"  href="' . $submenu3['url'] . '"  url_target="#submenu-' . $submenu3_id . '">' . $submenu3['title'] . '</a>';
