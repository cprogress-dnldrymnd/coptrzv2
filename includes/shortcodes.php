...
class Shortcodes
{
	...
	function tab_center()
	{
		ob_start();
	?>
		<section class="tabs-center-content background-secondary lg-padding-top lg-padding-bottom   " id="tabs-center-content-137-0">
				...
				<div class="accordion-box mt-5 d-block d-lg-none">
					<div class="accordion accordion-flush" id="accordionImageCenter">
						<div class="accordion-item">
							<h2 class="accordion-header" id="flush-0">
								<button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#flush-collapse0" aria-expanded="false" aria-controls="flush-collapse0">
									<div class="icon-heading-holder col d-flex align-items-center d-lg-block">
										...
										<div class="image-box icon-box me-3 ">
											<svg xmlns="http://www.w3.org/2000/svg" width="40" height="40" viewBox="0 0 40 40" class="svg-image replaced-svg">
							...
							<div id="flush-collapse0" class="accordion-collapse collapse" aria-labelledby="flush-0" data-bs-parent="#accordionImageCenter">
								<div class="accordion-body content-margin text-start">
									<div class="description-box">
										<p>Studying with Coptrz Academy gives you access to the largest number of flight test centres across the
											UK.</p>
									</div>
									<div class="image-box image-center">
										<img decoding="async" class="jetpack-lazy-image" src="https://coptrz.com/wp-content/uploads/2023/08/Public-Safety.jpg" alt="">
										<img decoding="async" class="jetpack-lazy-image drone-image" src="" alt="">
									</div>
								</div>
							</div>
						</div>
						<div class="accordion-item">
							<h2 class="accordion-header" id="flush-1">
								<button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#flush-collapse1" aria-expanded="false" aria-controls="flush-collapse1">
									<div class="icon-heading-holder col d-flex align-items-center d-lg-block">
										...
										<div class="image-box icon-box me-3 ">
											<svg xmlns="http://www.w3.org/2000/svg" width="48.075" height="30.438" viewBox="0 0 48.075 30.438" class="svg-image replaced-svg">
												<g id="education-svgrepo-com_1_" data-name="education-svgrepo-com (1)" transform="translate(-2 -10.925)">
													<path id="Path_9" data-name="Path 9" d="M25.8,26.7a8.9,8.9,0,0,1-3.5-.8c-6.3-2.1-12.7-4.2-19-6.3a3.328,3.328,0,0,1-1-.6.567.567,0,0,1,0-1,3.881,3.881,0,0,1,1.1-.6c6.8-2,13.5-4,20.3-6.1a7.549,7.549,0,0,1,4.7,0l20.1,6a6.721,6.721,0,0,1,1.2.6.591.591,0,0,1,0,1.1,3.128,3.128,0,0,1-1,.5C42,21.7,35.3,24,28.5,26.2A6.184,6.184,0,0,1,25.8,26.7Z" fill="currentColor"></path>
													<path id="Path_10" data-name="Path 10" d="M12.5,27c-1-.2-1.2.4-1.2.9v7.6a2.518,2.518,0,0,0,.9,2c.2.2.5.4.7.6a17.275,17.275,0,0,0,5.4,2.3,29.715,29.715,0,0,0,11.5.7,26.369,26.369,0,0,0,7.3-2,8.512,8.512,0,0,0,2.7-1.8,1.832,1.832,0,0,0,.6-1.7c.1-2.4.1-4.9.1-7.4,0-1.4-1-1.2-1.4-1.1-3.5,1.2-7.2,2.3-10.7,3.5a7.735,7.735,0,0,1-5.2,0Z" fill="currentColor"></path>
													<path id="Path_11" data-name="Path 11" d="M45.9,24.7c-.3.1-.4.2-.4.6v6.8a1.854,1.854,0,0,1-.2.7c-.5,1.2-1,2.4-1.4,3.6a2.922,2.922,0,0,0,.6,3.1,3.45,3.45,0,0,0,.9.8,2.567,2.567,0,0,0,1.2.5,2.41,2.41,0,0,0,1.8-.7,4.62,4.62,0,0,0,.7-.7,3.273,3.273,0,0,0,.5-2.7,15.846,15.846,0,0,0-1.5-3.8,1.2,1.2,0,0,1-.2-.8V24.7c0-.5-.4-.4-.6-.3Z" fill="currentColor"></path>
												</g>
											</svg>
										</div>
										<div class="heading-box">
							...
							<div id="flush-collapse1" class="accordion-collapse collapse" aria-labelledby="flush-1" data-bs-parent="#accordionImageCenter">
								<div class="accordion-body content-margin text-start">
									<div class="description-box">
										<p>The drone industry is advancing every single day. Find out how you can get yourself airborne</p>
									</div>
									<div class="image-box image-center">
										<img decoding="async" class="jetpack-lazy-image" src="https://coptrz.com/wp-content/uploads/2023/08/Education-1.jpeg" alt="">
										<img decoding="async" class="jetpack-lazy-image drone-image" src="" alt="">
									</div>
								</div>
							</div>
						...
						<div class="accordion-item">
							<h2 class="accordion-header" id="flush-2">
								<button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#flush-collapse2" aria-expanded="false" aria-controls="flush-collapse2">
									<div class="icon-heading-holder col d-flex align-items-center d-lg-block">
										...
										<div class="image-box icon-box me-3 ">
											<svg xmlns="http://www.w3.org/2000/svg" width="51.878" height="35.916" viewBox="0 0 51.878 35.916" class="svg-image replaced-svg">
												<g id="eye-svgrepo-com" transform="translate(-4.915 -84.4)">
													<g id="Group_16" data-name="Group 16" transform="translate(4.915 84.4)">
														<path id="Path_16" data-name="Path 16" d="M191.694,185.7a7.452,7.452,0,1,0,7.094,7.444A7.284,7.284,0,0,0,191.694,185.7Z" transform="translate(-166.221 -175.186)" fill="currentColor"></path>
														<path id="Path_17" data-name="Path 17" d="M36.5,116.121a11.769,11.769,0,0,1,0-23.527,11.769,11.769,0,0,1,0,23.527Zm26.079-12.907C55.822,92.372,46.716,86.4,36.964,86.4s-18.858,5.972-25.613,16.814a2.171,2.171,0,0,0,0,2.287c6.755,10.842,15.861,16.814,25.613,16.814s18.847-5.972,25.613-16.814A2.171,2.171,0,0,0,62.577,103.214Z" transform="translate(-11.025 -86.4)" fill="currentColor"></path>
													</g>
												</g>
											</svg>
										</div>
							...
							<div id="flush-collapse2" class="accordion-collapse collapse" aria-labelledby="flush-2" data-bs-parent="#accordionImageCenter">
								<div class="accordion-body content-margin text-start">
									<div class="description-box">
										<p>Reduce risk, lower costs and save time by using an integrated drone solution in your organisation.
										</p>
									</div>
									<div class="image-box image-center">
										<img decoding="async" class="jetpack-lazy-image" src="https://coptrz.com/wp-content/uploads/2023/08/Inspection.jpg" alt="">
										<img decoding="async" class="jetpack-lazy-image drone-image" src="" alt="">
									</div>
								</div>
							</div>
							...
							<h2 class="accordion-header" id="flush-3">
								<button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#flush-collapse3" aria-expanded="false" aria-controls="flush-collapse3">
									<div class="icon-heading-holder col d-flex align-items-center d-lg-block">
										...
										<div class="image-box icon-box me-3 ">
											<svg xmlns="http://www.w3.org/2000/svg" width="40.118" height="50" viewBox="0 0 40.118 50" class="svg-image replaced-svg">
												<g id="pair-of-compasses-svgrepo-com" transform="translate(-4.941)">
													<g id="Group_14" data-name="Group 14" transform="translate(4.941)">
														<path id="Path_3" data-name="Path 3" d="M15.894,18.356C12.02,29.4,4.941,50,4.941,50S15.814,37.508,23.658,28.422c-4.436-5.151-6.767-7.914-6.957-8.241A9.793,9.793,0,0,1,15.894,18.356Z" transform="translate(-4.941 0)" fill="currentColor"></path>
														<path id="Path_4" data-name="Path 4" d="M45.059,50S32.126,12.372,31.653,11.551a7.57,7.57,0,0,0-4.43-3.476V2.224a2.223,2.223,0,1,0-4.446,0V8.1a7.573,7.573,0,0,0-4.316,11.063C18.935,19.986,45.059,50,45.059,50ZM25,12.311a3.554,3.554,0,1,1-3.553,3.553A3.554,3.554,0,0,1,25,12.311Z" transform="translate(-4.941)" fill="currentColor"></path>
													</g>
												</g>
											</svg>
										</div>
										<div class="heading-box">
											<h4>
												Surveying &amp; construction </h4>
										</div>
									</div>
								</button>
							</h2>
							<div id="flush-collapse3" class="accordion-collapse collapse" aria-labelledby="flush-3" data-bs-parent="#accordionImageCenter">
								<div class="accordion-body content-margin text-start">
									<div class="description-box">
										<p>Drones are helping surveyors to carry out operations faster, safer and more cost effective.</p>
									</div>
									<div class="image-box image-center">
										<img decoding="async" class="jetpack-lazy-image" src="https://coptrz.com/wp-content/uploads/2023/08/Survey.png" alt="">
										<img decoding="async" class="jetpack-lazy-image drone-image" src="" alt="">
									</div>
								</div>
							</div>
						...
						<div class="col-12 col-lg col-left">
							<div class="column-holder py-5">
								<div class="nav nav-tabs" role="tablist">
									<button class="nav-link text-start active" id="nav-0-tab" data-bs-toggle="tab" data-bs-target="#nav-0" type="button" role="tab" aria-controls="nav-0" aria-selected="true">
										<div class="icon-heading-holder d-flex align-items-center d-lg-block">

											<div class="image-box icon-box mb-4 me-3 ">
												<svg xmlns="http://www.w3.org/2000/svg" width="40" height="40" viewBox="0 0 40 40" class="svg-image replaced-svg">
													<path id="Subtraction_1" data-name="Subtraction 1" d="M2329,164h-30a5.005,5.005,0,0,1-5-5V129a5.005,5.005,0,0,1,5-5h30a5.005,5.005,0,0,1,5,5v30A5.005,5.005,0,0,1,2329,164Zm-25-32a1,1,0,0,0-1,1v23a1,1,0,0,0,1,1h20a1,1,0,0,0,1-1v-5a1,1,0,0,0-1-1h-14V133a1,1,0,0,0-1-1Z" transform="translate(-2294 -124)" fill="currentColor"></path>
												</svg>
											</div>
										...
										<div class="description-box">
											<p>Studying with Coptrz Academy gives you access to the largest number of flight test centres across
												the UK.</p>
										</div>
									</button>
									<button class="nav-link text-start" id="nav-1-tab" data-bs-toggle="tab" data-bs-target="#nav-1" type="button" role="tab" aria-controls="nav-1" aria-selected="false">
										<div class="icon-heading-holder d-flex align-items-center d-lg-block">
...
add_shortcode('tab_center', array($Shortcodes, 'tab_center'));
