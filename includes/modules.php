...
function ___hero_product_taxonomy()
{
    ...
    $hero = "<section class='hero pb-50px rounded-10px $parent medium-hero bg-primary overflow-hidden text-white d-flex align-items-end mx-20px position-relative small-hero'>";
    $hero .= _background($hero_background);
    $hero .= "<div class='container'>";
