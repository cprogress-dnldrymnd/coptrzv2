...
function custom_product_variation_training($product_id, $delivery_method = 'online-self-paced', $sortby = 'latest', $location = false, $ajax = true)
{
    $SVG = new SVG;
            ...
            <div class="training-list ajax-loading">
                <div class="row">
                    <div class="col-lg-6">
                        ...
                        <div id="results">
                            <?= custom_product_variation_training($id, 'online-self-paced', 'latest', false, false) ?>
                        </div>
                    </div>
                    <div class="col-lg-6">
                        <?php $SVG = new SVG; ?>
