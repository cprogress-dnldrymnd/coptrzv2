...
function __servicing_fields()
{
    return array(
        ...
        Field::make('complex', 'remote_supporrt', 'Remote Supports')->set_classes('inline-field')
            ...
            ->set_collapsed(true),
        Field::make('html', 'servicing_html_4')->set_html('<label>DJI Mini Series</label>')->set_classes('cb-label'),
        Field::make('text', 'servicing_dji_mini_heading', 'Heading')->set_classes('inline-field'),
        Field::make('textarea', 'servicing_dji_mini_description', 'Description')->set_classes('inline-field'),
        Field::make('complex', 'servicing_dji_mini_drones', 'Drone Services')->set_classes('inline-field')
            ->add_fields(array(
                Field::make('text', 'dji_mini_service_type', 'Service Type')->set_classes('inline-field'),
                Field::make('text', 'dji_mini_subheading', 'Subheading')->set_classes('inline-field'),
                Field::make('text', 'dji_mini_price', 'Price')->set_classes('inline-field'),
                Field::make('complex', 'dji_mini_features', 'Features')->set_classes('inline-field')
                    ->add_fields('drone', array(
                        Field::make('text', 'quantity', __('Custom Text'))->set_classes('inline-field'),
                    ))
                    ->add_fields('battery', array(
            ...
            ->set_header_template('Drone Service: <%- dji_mini_service_type %>')
            ->set_collapsed(true),
    );
}
    ...
    ->add_tab(
        ...
        array(
            ...
            Field::make('complex', 'capabilities_archive_hero_buttons', __('Buttons'))->set_classes('inline-field inline-field-wide-label')
                ...
                ->set_header_template('Button: <%- button_text %>'),
            Field::make('html', 'capabilities_loop')->set_html('<label>Loop Section Settings</label>')->set_classes('cb-label'),
                ...
                Field::make('complex', 'section_items', __('Section Items'))
                    ...
                    ->add_fields('global_widgets', array(
                        Field::make('complex', 'global_widgets')
                            ...
                            ->add_fields('remote_support', array(
                                Field::make('html', 'html')->set_html('<h3>This will display remote support. </h3>'),
                            ))
                            ...
                            ->add_fields(array(
                                ...
                                Field::make('complex', 'items', __('Column Items'))
                                    ...
                                    ->add_fields('heading', array(
                                        ...
                                        Field::make('checkbox', 'has_prefix', __('Heading Has Prefix')),
                                        Field::make('checkbox', 'has_suffix', __('Heading Has Suffix')),
                                        Field::make('checkbox', 'has_custom_heading_settings', __('Custom Heading Settings')),
...
/* "Hide Before Footer Layout" is registered in functions.php
   (coptrz_register_global_layout_fields), unconditionally via the meta shim, so
   it is available on every template — including page-blocks-editor.php, on which
...
/* Custom CSS is registered in functions.php
   (coptrz_register_global_layout_fields), unconditionally via the meta shim, so
   it is available on all post types and on every template — including
   page-blocks-editor.php, on which this file is skipped in admin. Do not re-add
   it here (duplicate container). */
