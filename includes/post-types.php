...
$Quiz->supports = array('title', 'revisions', 'editor');
$Quiz->exclude_from_search = false;
$Quiz->publicly_queryable = true;
...
$Documents->supports = array('title', 'revisions', 'thumbnail');
