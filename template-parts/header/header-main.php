...
?>
<div class="header-inner <?= $announcement_bar ? 'has-annoucement' : '' ?> <?= (is_active_sidebar('top_bar_left') || is_active_sidebar('top_bar_right')) ? 'has-top-bar' : '' ?>">
                ...
                <div class="col col-lg-auto col-logo">
                    <div class="column-holder">
                        <div class="site-logo-holder position-relative">
                            <a href="<?= get_site_url() ?>" class="site-logo position-relative">
                    ...
                    <div class="column-holder d-inline-flex align-items-center">
                        ...
                        <div class="button-group-box">
                            <div class="button-box button-link button-small d-none d-lg-block">
                                <button style="padding-left: 0 !important; padding-right: 0 !important" class="px-0" onclick="window.dispatchEvent(new CustomEvent('heyflow-modal-element:open', { detail: { modalId: '9npbleZmTQmuV3CmsLi8q' }}))">Contact
                                    us</button>

                            </div>
                            <div class="button-box button-link button-small d-none d-lg-block">
                                <?php if (current_user_can('administrator')) { ?>
                                    <button class="button-login-mega-menu" style="padding-left: 0 !important; padding-right: 0 !important">
                                        Login
                                ...
                                <?php } else { ?>
                                    <?= do_shortcode('[login_dropdown]') ?>
                                <?php } ?>

                            </div>
                            <div class="button-box button-accent button-small d-none d-lg-block">
                                <button onclick="window.dispatchEvent(new CustomEvent('heyflow-modal-element:open', { detail: { modalId: 'uXa4D8wfqygIKfamkEoOY' }}))">
                                    ENQUIRE NOW
                                </button>
    ...
    <?php if (current_user_can('administrator')) { ?>
        <div class="login-mega-menu background-white">
            <?= do_shortcode('[elementor-template id="98823"]') ?>
        </div>
    <?php } ?>
</div>