    ...
    <div class="top-header py-3 background-body">
        <div class="container">
            <div class="row align-items-center">
                ...
                <div class="col-3">
                    <?= do_shortcode('[woocommerce_mini_cart_with_icon_shortcode]') ?>
        ...
        <div class="container">
            ...
            wp_nav_menu(
                array(
                    ...
                    'items_wrap'     => '<ul id="%1$s" class="navbar-nav fw-semibold text-uppercase align-items-center flex-row justify-content-between %2$s">%3$s</ul>',
                    'depth'          => 3,
