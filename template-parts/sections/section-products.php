<?php
$post_ids = [374321, 70720, 372804, 372813, 291382, 291384, 61752, 373354, 380888, 60988, 61238];
?>
...
<section class="products-section my-6" id="Related-Products">
    <div class="container ">
        <div class="container-wrapper">
            ...
            <div class="button-accent col-auto button-box text-center  mt-5"><a class="rounded-10px " href="#Benefits" target="_self">Explore Our DJI Enterprise Range</a></div>
        </div>
    </div>
</section>
