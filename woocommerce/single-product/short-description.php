...
$custom_phone_number = get__post_meta('custom_phone_number');
if($custom_phone_number) {
	$phone_number = $custom_phone_number;
} else {
	$phone_number = get__theme_option('phone_number');
}
?>
	...
	<div class="icon-list">
		<ul class="list-inline d-flex">
			<li class="d-flex align-items-center">
				...
				<span>Call Us Now On <a href="tel:<?= $phone_number ?>"><?= $phone_number ?></a></span>
			</li>
		</ul>
	</div>
</div>
